...
Pod::Spec.new do |s|
  s.name             = 'HexaColor'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HexaColor.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/HexaColor'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jerome Morissard' => 'jerome.morissard@backelite.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/HexaColor.git', :tag => s.version.to_s }
